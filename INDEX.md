...
2. **Алгоритмы** - Big O, базовые структуры данных, популярные задачи
3. **PostgreSQL** - индексы, ACID, оптимизация
4. **Практические задачи** - решить задачи от российских компаний

### Для глубокой подготовки (1+ месяц):
1. Полное изучение Golang Core
2. Все алгоритмы и структуры данных
3. PostgreSQL + Redis + архитектура БД
4. Микросервисы, gRPC, message brokers
5. Docker + Kubernetes
6. Практические задачи от всех компаний
